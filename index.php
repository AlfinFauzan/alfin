			  ...
			  <div class="row">
				<?php
				  ...
				  if(isset($_GET['kata_cari'])) {
					...
					$query = "SELECT * FROM foto,user WHERE foto.UserID=user.UserID like '%".$kata_cari."%' OR JudulFoto like '%".$kata_cari."%' OR DeskripsiFoto like '%".$kata_cari."%'  ORDER BY FotoID ASC";
				  } else {
				...
				<div class="col-md-4">
				  <div class="card card-widget">
					...
					<div class="card-body">
					  ...
					  <img class="d-block w-100" src="gambar/<?=$data['LokasiFile']?>" height="200"></a>
