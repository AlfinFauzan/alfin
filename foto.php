             ...
             <form role="form" action="tambah_foto.php" method="post" enctype="multipart/form-data">
							<div class="card-body">
							  ...
							  <div class="form-group">
								...
								<input type="text" class="form-control" id="" placeholder="" name="DeskripsiFoto">
							  </div>
							  <div class="form-group">
                  ...
                  <tr>       
					...
					if($result) //artinya jika query berhasil dijalankan  
					{
						while($data = mysqli_fetch_assoc($result))
						{
							...
							echo "<a href='hapus_foto.php?id=$fotoid' class='btn btn-block btn-outline-danger btn-flat' onclick='return confirm(\"Yakin ingin menghapus foto ini?\")'><i class=''></i>Hapus</a></td>";
							echo "</tr>";
						}
					}
					echo "</table>";
